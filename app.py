...
# ============================================================
PDF_LIGHT_HEADER = colors.HexColor("#FFF7F7")
PDF_LIGHT_HEADER_STROKE = colors.HexColor("#FECACA")
PDF_HERO_RED = colors.HexColor("#E31837")
PDF_TEXT_DARK = colors.HexColor("#111827")
PDF_TEXT_MUTED = colors.HexColor("#64748B")
PDF_TABLE_HEADER = colors.HexColor("#FFE4E6")
PDF_ROW_ALT = colors.HexColor("#FFF7F7")


def draw_pdf_light_hero_header(c, w, h, title, subtitle="", right_line1="", right_line2=""):
    """
    Print-friendly PDF header with light color and big HERO logo text.
    Less dark ink, keeps professional HERO style.
    """
    c.setFillColor(PDF_LIGHT_HEADER)
    c.roundRect(30, h - 96, w - 60, 74, 14, fill=True, stroke=False)
    c.setStrokeColor(PDF_LIGHT_HEADER_STROKE)
    c.roundRect(30, h - 96, w - 60, 74, 14, fill=False, stroke=True)
    ...
    c.drawString(48, h - 74, "SELVA MOTORS")

    c.setFillColor(PDF_TEXT_MUTED)
    c.setFont("Helvetica", 8)
    c.drawString(48, h - 87, "Professional Service ERP")
