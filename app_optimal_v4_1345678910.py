...
def generate_daily_technician_report_pdf(df, report_date, technician_name="All Technicians"):
    ...
    logo_drawn = draw_hero_logo_on_pdf(c, 38, h - 70, width=118, height=44)
    if not logo_drawn:
    ...
    c.drawString(38, h - 82, "SELVA MOTORS")
    c.setFillColor(colors.white)
...
def generate_manual_bill_pdf(customer_name, reg_no, bike_model, spare_rows, labour_amount, service_type):
    ...
    logo_drawn = draw_hero_logo_on_pdf(c, 40, h - 67, width=118, height=44)
    if not logo_drawn:
        c.setFillColor(colors.white)
        c.setFont("Helvetica-Bold", 24)
    ...
    c.drawString(40, h - 78, "SELVA MOTORS")
